...
class Data_Processor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            logger.info("Dropping the irrelevant columns")     
            ...
            for col in cat_cols:
                ...
                mappings[col] = {label: code for label, code in zip(lable_encoder.classes_, lable_encoder.transform(lable_encoder.classes_))}  
    ...
    def select_features(self,df):
        try:
            logger.info("Feature selection step initiated")
